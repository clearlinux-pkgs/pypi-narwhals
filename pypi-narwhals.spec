...
Source0  : https://files.pythonhosted.org/packages/ec/1d/a21496389436e96394a6e3fb1a644d5bc382250baff76e867f0368a94068/narwhals-1.34.0.tar.gz
...
%prep
%setup -q -n narwhals-1.34.0
cd %{_builddir}/narwhals-1.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744037952
