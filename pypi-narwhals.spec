...
Source0  : https://files.pythonhosted.org/packages/85/fd/484aa8bb557f97a1781f38c78b79f795a2fa320e4165c4230f679937d1e8/narwhals-1.33.0.tar.gz
...
%prep
%setup -q -n narwhals-1.33.0
cd %{_builddir}/narwhals-1.33.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743454300
