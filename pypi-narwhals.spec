...
Source0  : https://files.pythonhosted.org/packages/56/9b/59c34cf7c008df466d522e098913e3144d755b21facbb84fa70130f94217/narwhals-1.21.0.tar.gz
...
%prep
%setup -q -n narwhals-1.21.0
cd %{_builddir}/narwhals-1.21.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736175577
